...
if __name__ == '__main__':
    ...
    df = df[['score', 'content_1']].dropna()# 原邮件数据中有很多Nan的值，直接扔了。
    s=get_cut()
    ...
    lda.save('datasets.pkl')  # 保存到文件wiki_ida.pkl中
    model = gensim.models.ldamodel.LdaModel.load('datasets.pkl')  # 从文件wiki_ida.pkl中读出结果数据
